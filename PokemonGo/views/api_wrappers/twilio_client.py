...
class TwilioClient:
	...
	@staticmethod
	def send_message_to(pokemon='Pokemon', latitude=37.410294, longitude=-122.036461, to="4087180622"):
		client = TwilioRestClient(TwilioClient.sid, TwilioClient.secret)
		message = client.messages.create(body="A " + pokemon + " was found at (" + str(latitude) + ", " + str(longitude) + ")", to=to, from_="16507536256")
		return message
